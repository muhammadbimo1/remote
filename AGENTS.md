...
- **CSP Lua Skill**: Use the [CSP Lua skill](./.Codex/skills/csp-lua/SKILL.md) for API reference. Update it when it points you into the wrong place.
- **Full API Reference**: See [.Codex/skills/csp-lua/reference/lib.lua](./.Codex/skills/csp-lua/reference/lib.lua) for complete CSP type definitions (17k+ lines).